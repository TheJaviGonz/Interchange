		...
		<!-- Main -->
			<div id="main">
				...
				<!-- One -->
					<section id="one">
						<header class="major">
							<h2>En este espacio podras consultar las peticiones que estan haciendo ahora mismo los que te escuchan</h2>
						</header>
				...
				<section id="two">
					...
					<div>
					<p>Introduzca el codigo de la cancion para ponerla en el play que que todos sepan que se esta escuchando</p>
					<form id="form1" name="form1" method="post" action="validar.php">
						<td><input type="username" name="codigo" id="codigo" placeholder="codigo" />&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td>
						<td>&nbsp&nbsp&nbsp&nbsp</td>
						<td><input type="submit" value="&nbsp&nbsp&nbsp&nbsp Enviar &nbsp&nbsp&nbsp&nbsp" /></td>
					</div>
...
$consulta = "select p.n_peticiones,p.cod_pet,c.nombre, c.artista, c.estilo
			 from canciones c, peticion p
			 where c.cod_cancion =  p.cod_cancion and p.nick = '$nom' and p.fecha_peticion = '$fecha2'
			 order by  p.n_peticiones DESC
...
if ($nfilas > 0):
	...
	echo "
		...
		<table>
		<tr align='center'>
				<td ><font size = 5><B><I>N_peticiones</font> </b></i></td>
				<td ><font size = 5><B><I>Codigo de peticion</font> </b></i></td>
